  ...
  while ((!exitg1) && (i + 1 >= 1)) {
      ...
      if (k + 2 >= i) {
        ...
        if (s == 0.0) {
          ...
          if (tst >= 0.0) {
            ...
            rt1r = ba + ab;
            bb = ba - ab;
            if (muDoubleScalarAbs(rt1r - h22) <= muDoubleScalarAbs(bb - h22)) {
              rt1r *= s;
              bb = rt1r;
            } else {
              bb *= s;
    ...
    if (!goto150) {
      ...
      if ((k + 2 != i + 1) && (k + 2 == i)) {
        ...
        d = h[nr];
        tst = h[hoffset];
        xdlanv2(&h[(i + 3 * (i - 1)) - 1], &s, &d, &tst, &ab, &aa, &ba, &bb,
                &h22, &rt1r);
        h[hoffset - 1] = s;
        h[nr] = d;
        h[hoffset] = tst;
        ...
        b_xrot(i - 1, h, (i - 1) * 3 + 1, i * 3 + 1, h22, rt1r);
      }
      i = k;
    }
  }
